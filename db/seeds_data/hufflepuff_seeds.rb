host = "https://school-of-magic-api.onrender.com/images/hufflepuff"
...
helga_hufflepuff = Character.find_or_create_by_with_wand(
    ...
    actor: 'Katie McGrath',
    alive: false,
    image_url: "#{host}/helga_hufflepuff.jpg",
    house: hufflepuff,
    wand_attributes: {
        wood: 'oak',
        core: 'unicorn hair',
