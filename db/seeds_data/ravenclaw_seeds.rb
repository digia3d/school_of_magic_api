host = "https://school-of-magic-api.onrender.com/images/ravenclaw"
...
xenophilius = Character.find_or_create_by_with_wand(
    ...
    actor: 'Rhys Ifans',
    alive: true,
    image_url: "#{host}/xenophilius.jpg",
    house: ravenclaw,
    wand_attributes: {
        wood: '',
        core: '',
