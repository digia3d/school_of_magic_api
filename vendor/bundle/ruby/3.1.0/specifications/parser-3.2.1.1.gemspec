...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/whitequark/parser/issues", "changelog_uri" => "https://github.com/whitequark/parser/blob/v3.2.1.1/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/parser/3.2.1.1", "source_code_uri" => "https://github.com/whitequark/parser/tree/v3.2.1.1" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<racc>.freeze, ["= 1.6.2"])
